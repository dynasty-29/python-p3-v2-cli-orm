...
def find_employee_by_name():
    ...
    employee = Employee.find_by_id(name_)
...
def update_employee():
    ...
    if employee := Employee.find_by_name(name_):
        ...
        print(f'Employee {name_} not found')


def delete_employee():
    name_ = input("Enter the employee's name: ")
    if employee := Department.find_by_name(name_):
        employee.delete()
        print(f'Employee {name_} deleted')
    else:
        print(f'Employee {name_} not found')
